...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam, frogpilot_toggles):
    ...
    if self.CP.carFingerprint != CAR.TOYOTA_PRIUS_V:
      ...
      self.lkas_status_previous = self.lkas_status
      self.lkas_status = self.lkas_hud.get("LKAS_STATUS") == 1
      self.lkas_enabled = self.lkas_status != self.lkas_status_previous
