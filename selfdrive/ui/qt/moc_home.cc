...
QT_MOC_LITERAL(12, 117, 12), // "showMapPanel"
QT_MOC_LITERAL(13, 130, 11), // "updateState"
QT_MOC_LITERAL(14, 142, 7), // "UIState"
QT_MOC_LITERAL(15, 150, 1) // "s"
    ...
    "showMapPanel\0updateState\0UIState\0s"
};
#undef QT_MOC_LITERAL
...
void HomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->showMapPanel((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 9: _t->updateState((*reinterpret_cast< const UIState(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
