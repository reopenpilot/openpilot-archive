...
struct qt_meta_stringdata_PedalIcons_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PedalIcons_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PedalIcons_t qt_meta_stringdata_PedalIcons = {
    {
QT_MOC_LITERAL(0, 0, 10) // "PedalIcons"
...
static const uint qt_meta_data_PedalIcons[] = {
...
void PedalIcons::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject PedalIcons::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_PedalIcons.data,
    qt_meta_data_PedalIcons,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *PedalIcons::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *PedalIcons::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PedalIcons.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int PedalIcons::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
