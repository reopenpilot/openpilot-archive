...
from openpilot.frogpilot.selfdrive.modeld.model_manager import ModelManager
from openpilot.frogpilot.selfdrive.ui.theme_manager import ThemeManager
...
from openpilot.frogpilot.common.frogpilot_variables import (
  ERROR_LOGS_PATH, EXCLUDED_KEYS, HD_LOGS_PATH, KONIK_LOGS_PATH, SCREEN_RECORDINGS_PATH, THEME_SAVE_PATH, VIDEO_CACHE_PATH,
  FrogPilotVariables, frogpilot_default_params, get_frogpilot_toggles, params
)
...
def frogpilot_boot_functions(build_metadata, params_cache, frogpilot_api):
  ...
  def boot_thread():
    ...
    run_thread_with_lock("send_stats", send_stats, (params, get_frogpilot_toggles(), frogpilot_api))
...
def setup_frogpilot(build_metadata):
  ...
  frogpilot_boot_logo = Path(__file__).parent / "assets/frogpilot_boot_logo.png"
...
def uninstall_frogpilot():
  boot_logo_location = Path("/usr/comma/bg.jpg")
  stock_boot_logo = Path(__file__).parent / "assets/stock_bg.jpg"
