...
class FrogPilotCard:
  ...
  def update(self, carState, frogpilotCarState, sm):
    ...
    self.always_on_lateral_enabled &= (ET.IMMEDIATE_DISABLE not in sm["controlsState"].alertType + sm["frogpilotControlsState"].alertType) or frogpilot_toggles.frogs_go_moo
