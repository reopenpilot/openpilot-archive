...
from openpilot.frogpilot.common.download_functions import GITLAB_URL, download_file, get_repository_url, handle_error, handle_request_error, verify_download
from openpilot.frogpilot.common.frogpilot_utilities import delete_file, load_json_file, update_json_file
from openpilot.frogpilot.selfdrive.modeld.model_helpers import (
  ALL_TINYGRAD_FILES, DEFAULT_MODEL, DEFAULT_MODEL_NAME, DEFAULT_MODEL_VERSION, MODELS_PATH, get_tinygrad_files
)
from openpilot.frogpilot.common.frogpilot_variables import RESOURCES_REPO, params, params_default, params_memory, update_frogpilot_toggles
...
TINYGRAD_MODELD_PATH = Path(BASEDIR) / "frogpilot/selfdrive/modeld/tinygrad"
...
class ModelManager:
  ...
  def copy_default_model(self):
    ...
    source_path = Path(__file__).parent / "classic/models/supercombo.thneed"
